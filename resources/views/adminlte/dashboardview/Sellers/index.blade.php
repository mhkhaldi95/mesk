        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <a href="{{route('dashboard.sellers.create')}}" style="width: 11%;float: left;margin-left: 16%;"  class="btn btn-primary"><i class="fa fa-plus"></i>اضافة</a>
...
$(document).on("click",'.remove-project',function(){
    ...
    swal({
        ...
        if (willDelete) {
            ...
            $.ajax({
                method:'POST',
                url: "/dashboard/sellers/delete/"+id,
